...
export default {
  ...
  async run(criv, { m,  text }) {
     ...
     try {
      const res = await axios.get(`https://api.siputzx.my.id/api/ai/llama33?prompt=gunakan%20bahasa%20Indonesia%2C%20dan%20namamu%20shiro%2C%20penciptamu%20bernama%20Cristave%2C%20kamu%20hanya%20akan%20menjawab%20siapa%20namamu%20dan%20pencipta%20mu%20hanya%20ketika%20ditanya%2C%20jika%20tidak%20maka%20jawab%20sesuai%20pertanyaan&text=${encodeURIComponent(text)}`)   
